...
This bot is a fork from on https://github.com/AvalerionHF/PancakeSwap-Prediction-v2
Oracle for BNB prediction has been added to ensure a `higher chance of winning`
...
- Type ``cd PancakeSwap-Prediction-v2-oracle`` (replace with your cloned/downloaded bot folder)
- Type ``npm i``
...
YOUR_ACCOUNT_PRIVATE_KEY="your private key here"
...
# Your walled address
YOUR_ACCOUNT_ADDRESS="your wallet address here"
```
